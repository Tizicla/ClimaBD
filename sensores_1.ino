...
void loop() {
    ...
    // Get the number of child node in historio to make up the count
    if (Firebase.getJSON(fbdo, "/sensorHist/historico")) {
        FirebaseJson &json = fbdo.jsonObject();
         count = json.iteratorBegin();
        // size_t count = json.iteratorBegin();
        Serial.println("Number of child nodes: " + count);
